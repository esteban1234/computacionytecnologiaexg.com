...
//To address and name
$mail->addAddress("info@computacionytecnologiaexg.com");



$mail->isHTML(true);

$mail->Subject = "Cotización COMPUTACION Y TECNOLOGIA INTEGRAL EXG";
$mail->Body = "
              <!DOCTYPE html>
                <html>
                <head>
                ...
                <h1 style='text-align:center;  font-weight: bold'> COMPUTACION Y TECNOLOGIA INTEGRAL EXG</h1>
